%% --------------------------------------------------------------------- %%
%                   Modello polinomiale di Grasso corporeo vs Età
% -----------------------------------------------------------------------

figure('Name','Grasso corporeo vs Età')
plot(dati_iden(:, 2), dati_iden(:, 1), 'x'); 
...
%        Plot diviso
% --------------------------------
figure('Name','Modelli Polinomiali età')
...
sgtitle('Modelli polinomiali - grasso vs età')
...
clc
disp('Modelli polinomiali di Età vs Grasso corporeo')
disp('---------------------------------------------------')
...
% pulizia delle vecchie variabili 
% così non c'è il rischio di sovrascrivere
clear f1 f2 f3 f4
clear f_alpha1 f_alpha2 f_alpha3 f_alpha4
...
clear AIC AIC0 AIC1 AIC2 AIC3 AIC4 
clear FPE FPE0 FPE1 FPE2 FPE3 FPE4 
clear MDL MDL0 MDL1 MDL2 MDL3 MDL4 
...
clear f1 f2 f3 f4
clear f_alpha1 f_alpha2 f_alpha3 f_alpha4
clear epsilonVal0 epsilonVal1 epsilonVal2 epsilonVal3 epsilonVal4
clear phiVal0 phiVal1 phiVal2 phiVal3 phiVal4
clear SSRv SSRVal0 SSRVal1 SSRVal2 SSRVal3 SSRVal4
clear ystimaVal0 ystimaVal1 ystimaVal2 ystimaVal3 ystimaVal4
