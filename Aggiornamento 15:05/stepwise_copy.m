...
% richiede le variabili in forma matriciale e non di cell array
MM = [M{:}]; 
...
subplot 231
plot(Y, Y_hat, '*r')
xlabel('identificazione')
ylabel('regressione a mano')
title('set di identificazione')

subplot 232
plot(Y, Ysw, '*b')
xlabel('identificazione')
ylabel('regressione matlab')
title('set di identificazione')

subplot 233
plot(Y_hat, Ysw, '*g')
xlabel('regressione a mano')
ylabel('regressione matlab')
title('regressione')

subplot 234
plot(Y_val, Y_hat_val, '*r')
xlabel('identificazione')
ylabel('regressione a mano')
title('set di validazione')
...
subplot 236
plot(Y_hat_val, Yv_sw, '*g')
xlabel('regressione a mano')
ylabel('regressione matlab')
title('regressione')

sgtitle('Stepwise Regression')


%% --------------------------------
% pulizia delle variabili
clear alfa b c C CV F Fmax Ftest
clear g I_inf I_sup index indF indice 
clear k l m mat p p_value R2 R2a R2ac R2av
clear x Xp 
