...
% ---------------------------------------
% plot
figure('Name','IMC e età vs Grasso 1')
...
% ---------------------------------------
% plot
figure('Name','IMC e età vs Grasso 2')
...
% ---------------------------------------
% plot
figure('Name','IMC e età vs Grasso 3')
...
% ---------------------------------------
% plot
figure('Name','IMC e età vs Grasso 4')
...
% ---------------------------------------
% plot
figure('Name','IMC e età vs Grasso 5')
...
%% ------------------------------------------------
% pulizia 
clear superficie1 superficie2 superficie3 superficie4 superficie5 
clear superficie1_matrix superficie2_matrix superficie3_matrix
clear superficie4_matrix superficie5_matrix
clear phi1_grid phi2_grid phi3_grid phi4_grid phi5_grid
...
clc
disp('Modelli polinomiali di IMC e età vs Grasso corporeo')
disp('---------------------------------------------------')
AIC = [AIC1 AIC2 AIC3 AIC4 AIC5];
k = min(AIC);
AIC_min = find(AIC == k);
disp(['AIC minimo è quello associato al modello ', num2str(AIC_min)]);

% FPE minimo è quello del modello 3
FPE = [FPE1 FPE2 FPE3 FPE4 FPE5];
clear k
k = min(FPE);
FPE_min = find(FPE == k);
disp(['FPE minimo è quello associato al modello ', num2str(FPE_min)]);

% MDL minimo è quello del modello 3
MDL = [MDL1 MDL2 MDL3 MDL4 MDL5];
clear k
k = min(MDL);
MDL_min = find(MDL == k);
disp(['MDL minimo è quello associato al modello ', num2str(MDL_min)]);
...
if f2 < f_alpha2
    ...
    if f3 < f_alpha3
        ...
        if f4 < f_alpha4
            ...
            disp('Test di fisher migliore è associato al modello 5');
...
%% ------------------------------------------------
% pulizia 
clear AIC AIC1 AIC2 AIC3 AIC4 AIC5 
clear FPE FPE1 FPE2 FPE3 FPE4 FPE5
clear MDL MDL1 MDL2 MDL3 MDL4 MDL5 
clear k q0 q1 q2 q3 q4 q5